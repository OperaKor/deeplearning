##머신 러닝에 앞서 아나콘다를 설치.
##윈도우 10를 사용중이기 때문에 윈도우 10을 기준으로 
##http://www.continuum.io/downloads
##설치 후 Anaconda Prompt 실행
##아나콘다 환경과 실습용 작업 환경을 tutorial 이란 이름으로 생성하여 저장한답니다.

(base) C:\Users\sk910>conda create -n tutorial python=3.5 numpy scipy matplotlib spyder pandas seaborn scikit-learn h5py
...
##콘다의 새로운 버전이 있다는데 업데이트 해야하나?

## Package Plan ##

  environment location: C:\Users\sk910\Anaconda3\envs\tutorial
...
Executing transaction: / DEBUG menuinst_win32:__init__(196): Menu: name: 'Anaconda${PY_VER} ${PLATFORM}', prefix: 'C:\Users\sk910\Anaconda3\envs\tutorial', env_name: 'tutorial', mode: 'user', used_mode: 'user'
DEBUG menuinst_win32:create(320): Shortcut cmd is C:\Users\sk910\Anaconda3\pythonw.exe, args are ['C:\\Users\\sk910\\Anaconda3\\cwp.py', 'C:\\Users\\sk910\\Anaconda3\\envs\\tutorial', 'C:\\Users\\sk910\\Anaconda3\\envs\\tutorial\\pythonw.exe', 'C:\\Users\\sk910\\Anaconda3\\envs\\tutorial\\Scripts\\spyder-script.py']
- DEBUG menuinst_win32:create(320): Shortcut cmd is C:\Users\sk910\Anaconda3\python.exe, args are ['C:\\Users\\sk910\\Anaconda3\\cwp.py', 'C:\\Users\\sk910\\Anaconda3\\envs\\tutorial', 'C:\\Users\\sk910\\Anaconda3\\envs\\tutorial\\python.exe', 'C:\\Users\\sk910\\Anaconda3\\envs\\tutorial\\Scripts\\spyder-script.py', '--reset']
done
#
...
#     $ conda deactivate
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
##activate tutorial 실행
(base) C:\Users\sk910>activate tutorial

(tutorial) C:\Users\sk910>pip install tensorflow
##책에서 이렇게 하라 해서 텐서플로우를 설치해보려 했으나...
...
Requirement already satisfied: wheel>=0.26 in c:\users\sk910\anaconda3\envs\tutorial\lib\site-packages (from tensorflow) (0.31.1)
...
Collecting grpcio>=1.8.6 (from tensorflow)
  Using cached https://files.pythonhosted.org/packages/f4/6a/ad4a8ee21edd417274cb2327045ac59fc5d05b8764d4663c356c24a128e0/grpcio-1.13.0-cp35-cp35m-win_amd64.whl
Requirement already satisfied: numpy>=1.13.3 in c:\users\sk910\anaconda3\envs\tutorial\lib\site-packages (from tensorflow) (1.15.0)
...
Requirement already satisfied: six>=1.10.0 in c:\users\sk910\anaconda3\envs\tutorial\lib\site-packages (from tensorflow) (1.11.0)
...
Installing collected packages: astor, setuptools, protobuf, absl-py, grpcio, werkzeug, markdown, tensorboard, termcolor, gast, tensorflow
  Found existing installation: setuptools 39.2.0
    Uninstalling setuptools-39.2.0:
      Successfully uninstalled setuptools-39.2.0
Successfully installed absl-py-0.3.0 astor-0.7.1 gast-0.2.0 grpcio-1.13.0 markdown-2.6.11 protobuf-3.6.0 setuptools-39.1.0 tensorboard-1.9.0 tensorflow-1.9.0 termcolor-1.1.0 werkzeug-0.14.1
You are using pip version 10.0.1, however version 18.0 is available.
You should consider upgrading via the 'python -m pip install --upgrade pip' command.

##업그레이드도 하라 하네요

(tutorial) C:\Users\sk910>python -m pip install --upgrade pip
Collecting pip
